...
*   **Структура таблиц** - Названия, порядок и тип данных полей максимально соответствуют между собой в 1С и PostgreSQL
...
*   **Пустые значения**  - пустые значения (NULL) в результатах SQL-запросов максимально соответствуют в 1С и PostgreSQL (например, дата 01.01.0001)
*   **Составной тип данных 1С** - поддерживается составной тип данных 1С, для него в PostgreSQL создан тип [pg1c.value_any](https://htmlpreview.github.io/?https://github.com/PG1C/PG1C/blob/main/documentation/documentation.html#value_any)
